import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, l as loadConfig, H as HttpAgent, S as StorageClient, g as getSession, X, F as FileText, D as Download } from "./index-Z0A2bhGv.js";
...
import { P as Primitive, L as Label } from "./label-CKr0yFvu.js";
...
import { g as useGetLoanById, a as useAdminGetAllUsers, c as useAdminDeleteLoan, h as useAdminUpdateLoan, i as useAdminGetLoanDocuments, j as useAdminAddDocument, k as useAdminDeleteDocument, l as useAdminRemoveUserFromLoan, m as useAdminUpdateStage, n as useAdminUnrejectLoan, o as useAdminAddUserToLoan, p as useAdminRejectLoan } from "./useQueries-Bvv08CbZ.js";
...
function LoanInfoCard({
  ...
  const [editingFinancials, setEditingFinancials] = reactExports.useState(false);
  const [financialForm, setFinancialForm] = reactExports.useState({
  ...
  const [financialErr, setFinancialErr] = reactExports.useState("");
  const [err, setErr] = reactExports.useState("");
  ...
  async function handleSaveFinancials() {
    setFinancialErr("");
    const requiredAmt = financialForm.requiredAmount ? Number(financialForm.requiredAmount) : void 0;
    const sanctionAmt = financialForm.sanctionAmount ? Number(financialForm.sanctionAmount) : void 0;
    const disbursedAmt = financialForm.disbursedAmount ? Number(financialForm.disbursedAmount) : void 0;
    if (requiredAmt !== void 0 && Number.isNaN(requiredAmt) || sanctionAmt !== void 0 && Number.isNaN(sanctionAmt) || disbursedAmt !== void 0 && Number.isNaN(disbursedAmt)) {
    ...
    try {
      ...
      setFinancialErr(e.message ?? "Failed to save financial data.");
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card border border-border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      !isReadOnly && (editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Financial Details" }),
          canEditFinancials && (editingFinancials ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  updateLoan.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 13, className: "animate-spin mr-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { size: 13, className: "mr-1" }),
                  "Save"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Required Amount (₹)" }),
            canEditFinancials && editingFinancials ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: loan.requiredAmount ? formatCurrency(loan.requiredAmount) : "—" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Sanction Amount (₹)" }),
            canEditFinancials && editingFinancials ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: loan.sanctionAmount ? formatCurrency(loan.sanctionAmount) : "—" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Disbursed Amount (₹)" }),
            canEditFinancials && editingFinancials ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: loan.disbursedAmount ? formatCurrency(loan.disbursedAmount) : "—" })
          ] })
        ] }),
        (loan.requiredAmount || loan.sanctionAmount || loan.disbursedAmount) && !editingFinancials && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "Financial Summary:" }),
              loan.requiredAmount ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                "Required:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: formatCurrency(loan.requiredAmount) })
              ] }) : null,
              loan.sanctionAmount ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                "Sanctioned:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: formatCurrency(loan.sanctionAmount) })
              ] }) : null,
              loan.disbursedAmount ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                "Disbursed:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: formatCurrency(loan.disbursedAmount)
                  }
                )
              ] }) : null
            ]
        ...
        financialErr && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-destructive flex items-center gap-1.5 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 13 }),
          financialErr
        ] })
      ] })
...
function AssignedUsersCard({
  ...
  const internalUsers = assignedUserIds.filter(
    (uid) => {
      var _a;
      return (((_a = userMap.get(uid)) == null ? void 0 : _a.user_type) || "internal") !== "external";
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-card border border-border bg-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        assignedUserIds.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic py-2 text-center", children: "No users assigned yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            internalUsers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground italic ml-1", children: "No internal users assigned." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: internalUsers.map((uid) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              UserChip,
              {
                uid,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider mb-2 px-2 py-1 rounded bg-muted/40 text-muted-foreground", children: "External Team" }),
            externalUsers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground italic ml-1", children: "No external users assigned." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: externalUsers.map((uid) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              UserChip,
              {
                uid,
                user: userMap.get(uid),
...
function LoanDetailPage({ loanId }) {
  ...
  const isExternalUser = (() => {
    ...
    return ((userRecord == null ? void 0 : userRecord.user_type) ?? "internal") === "external";
  })();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-6 space-y-5 animate-fade-in print:px-0 print:py-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DocumentsSection, { loanId, isReadOnly }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
          ...
          !isReadOnly && /* @__PURE__ */ jsxRuntimeExports.jsx(RejectActionCard, { loan })
        ] })
      ] })
    ] }),
