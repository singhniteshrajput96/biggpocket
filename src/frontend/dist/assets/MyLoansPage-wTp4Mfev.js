import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, F as FileText } from "./index-Z0A2bhGv.js";
import { B as Badge } from "./badge-DtlJb9-W.js";
import { C as Card, b as CardHeader, a as CardContent } from "./card-BdbFX_7A.js";
    ...
    Card,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-2.5", children: [
          ...
          (loan.sanctionAmount ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground w-16 shrink-0 text-xs", children: "Sanctioned" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-mono font-medium", children: formatCurrency(loan.sanctionAmount) })
          ] }),
          (loan.disbursedAmount ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground w-16 shrink-0 text-xs", children: "Disbursed" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function getFilterLabel(type, stage) {
...
function MyLoansPage() {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    if (filterType === "active") {
      return loans.filter(
        (l) => l.loan.isActive && !l.loan.isRejected && l.loan.currentStage < LOAN_STAGES.length - 1
      );
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-8 animate-fade-in", children: [
    ...
    hasFilter && !isLoading && !isError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
      ...
      filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "No loans match this filter." })
    ] }),
    ...
    !isLoading && !isError && loans && loans.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-5 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          " application",
          filtered.length !== 1 ? "s" : "",
          hasFilter && loans.length !== filtered.length && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-xs", children: [
            "(of ",
            loans.length,
            " total)"
          ] })
        ] }),
        !hasFilter && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: filtered.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(LoanCard, { item }, item.loan.id))
        }
      ) : (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-dashed border-border bg-card p-10 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: { color: "#F47B30" },
              onClick: clearFilter,
              children: "Clear filter to see all loans"
            }
          )
        ] })
      )
