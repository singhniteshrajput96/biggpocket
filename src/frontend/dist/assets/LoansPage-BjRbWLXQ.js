import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, U as Users } from "./index-DmlGt2ze.js";
import { B as Badge } from "./badge-DJ6ESDy9.js";
import { B as Button } from "./button-BNrAkQWu.js";
import { C as Card, a as CardContent } from "./card-UU8wv2cG.js";
...
import { a as useAdminGetAllUsers, b as useAdminGetAllLoans, c as useAdminDeleteLoan, d as useAdminCreateLoan } from "./useQueries-Cl2674ke.js";
import { S as Search } from "./search-D-v2OZ46.js";
...
function CreateLoanModal({ onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setFormErrors({
        submit: err.message ?? "Failed to create loan"
      });
    }
  }
...
function AssignedChips({ userIds, userMap }) {
  if (userIds.length === 0)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground italic", children: "—" });
