import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, F as FileText } from "./index-Z0A2bhGv.js";
import { S as Skeleton } from "./skeleton-CxBnDwkK.js";
import { L as LOAN_STAGES, R as REJECTED_STAGE_LABEL } from "./stages-CnHug0GM.js";
import { v as useGetMyLoans } from "./useQueries-Bvv08CbZ.js";
...
import { R as ResponsiveContainer, P as PieChart, p as Pie, o as Cell, T as Tooltip, q as Legend, B as BarChart, m as CartesianGrid, X as XAxis, Y as YAxis, n as Bar } from "./PieChart-D4RDuL6O.js";
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: isClickable ? { outline: "none" } : { outline: "none", opacity: 1 },
      children: [
        ...
        isClickable && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium", style: { color: accent }, children: "Click to filter →" })
      ]
    }
  );
}
function DashboardSkeletons() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [0, 1].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border rounded-xl p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-24" }),
...
function CustomerDashboardPage() {
  ...
  const stats = reactExports.useMemo(() => {
    ...
    const totalDisbursedAmount = loans.filter((l) => !l.isRejected && l.currentStage >= 7).reduce((s, l) => s + (l.disbursedAmount ?? l.loanAmount), 0);
    const totalSanctionedAmount = loans.filter((l) => !l.isRejected && l.currentStage >= 6).reduce((s, l) => s + (l.sanctionAmount ?? l.loanAmount), 0);
    const stageMap = {};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-6 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: "My Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Overview of your loan portfolio · Click any card to filter loans" })
      ] })
    ] }),
      ...
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Click to view rejected loans. Contact your BiggPocket agent for more information." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      stats.stageData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-1", children: "Stage Distribution" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: "Click a slice to filter loans by stage" }),
      ...
      stats.valueData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-1", children: "Loan Value by Stage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: "Click a bar to filter loans by stage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            ...
            onClick: (e) => {
              var _a;
              if ((_a = e == null ? void 0 : e.activePayload) == null ? void 0 : _a[0]) {
