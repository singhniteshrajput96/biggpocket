...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, q as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, t as lookupResultToBuffer, w as RequestStatusResponseStatus, U as UnknownError, x as RequestStatusDoneNoReplyErrorCode, y as RejectError, z as CertifiedRejectErrorCode, A as UNREACHABLE_ERROR, I as InputError, B as InvalidReadStateRequestErrorCode, G as ReadRequestType, J as Principal, K as IDL, L as MissingCanisterIdErrorCode, H as HttpAgent, N as encode, Q as QueryResponseStatus, O as UncertifiedRejectErrorCode, V as isV3ResponseBody, W as isV2ResponseBody, Y as UncertifiedRejectUpdateErrorCode, Z as UnexpectedErrorCode, $ as decode, f as Subscribable, a0 as pendingThenable, a1 as resolveEnabled, h as shallowEqualObjects, a2 as resolveStaleTime, m as noop, a3 as environmentManager, a4 as isValidTimeout, a5 as timeUntilStale, a6 as timeoutManager, a7 as focusManager, a8 as fetchState, a9 as replaceData, n as notifyManager, r as reactExports, p as shouldThrowError, u as useQueryClient, aa as useInternetIdentity, ab as createActorWithConfig, ac as Record, ad as Variant, ae as Opt, af as Vec, ag as Tuple, ah as Service, ai as Func, aj as Text, ak as Nat, al as Bool, am as Int, an as Null, ao as Float64 } from "./index-Z0A2bhGv.js";
...
const DashboardStats = Record({
  ...
  "total_disbursed_amount": Nat,
  "dropoff_rate": Float64,
  "disbursed_count": Nat
});
const UpdateLoanInput = Record({
  "co_applicant_name": Opt(Text),
  "bank_name": Opt(Text),
  "required_amount": Opt(Nat),
  "employment_type": Opt(Text),
  "loan_amount": Opt(Nat),
  "loan_type": Opt(Text),
  "income": Opt(Nat),
  "sanction_amount": Opt(Nat),
  "property_value": Opt(Nat),
  "distribution_partner": Opt(Text),
  "disbursed_amount": Opt(Nat),
  "property_type": Opt(Text),
  "applicant_name": Opt(Text)
});
const UserDashboardStats = Record({
  "total_loans": Nat,
  "total_sanctioned_amount": Nat,
  "stage_breakdown": Vec(Tuple(Text, Nat)),
  "recent_loans": Vec(LoanApplication),
  "active_loans": Nat,
  "total_value": Nat,
  "total_disbursed_amount": Nat
});
...
Service({
  ...
  "getUserDashboard": Func(
    [Text],
    [Variant({ "ok": UserDashboardStats, "err": Text })],
    []
  ),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const DashboardStats2 = IDL2.Record({
    ...
    "total_sanctioned_amount": IDL2.Nat,
    ...
    "total_disbursed_amount": IDL2.Nat,
    "dropoff_rate": IDL2.Float64,
    "disbursed_count": IDL2.Nat
  });
  const UpdateLoanInput2 = IDL2.Record({
    "co_applicant_name": IDL2.Opt(IDL2.Text),
    "bank_name": IDL2.Opt(IDL2.Text),
    "required_amount": IDL2.Opt(IDL2.Nat),
    "employment_type": IDL2.Opt(IDL2.Text),
    "loan_amount": IDL2.Opt(IDL2.Nat),
    "loan_type": IDL2.Opt(IDL2.Text),
    "income": IDL2.Opt(IDL2.Nat),
    "sanction_amount": IDL2.Opt(IDL2.Nat),
    "property_value": IDL2.Opt(IDL2.Nat),
    "distribution_partner": IDL2.Opt(IDL2.Text),
    "disbursed_amount": IDL2.Opt(IDL2.Nat),
    "property_type": IDL2.Opt(IDL2.Text),
    "applicant_name": IDL2.Opt(IDL2.Text)
  });
  const UserDashboardStats2 = IDL2.Record({
    "total_loans": IDL2.Nat,
    "total_sanctioned_amount": IDL2.Nat,
    "stage_breakdown": IDL2.Vec(IDL2.Tuple(IDL2.Text, IDL2.Nat)),
    "recent_loans": IDL2.Vec(LoanApplication2),
    "active_loans": IDL2.Nat,
    "total_value": IDL2.Nat,
    "total_disbursed_amount": IDL2.Nat
  });
  ...
  return IDL2.Service({
    ...
    "adminGetDeletedLoans": IDL2.Func(
      [IDL2.Text],
    ...
    "adminUpdateLoan": IDL2.Func(
      [IDL2.Text, IDL2.Nat, UpdateLoanInput2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    ...
    "getUserDashboard": IDL2.Func(
      [IDL2.Text],
      [IDL2.Variant({ "ok": UserDashboardStats2, "err": IDL2.Text })],
      []
    ),
...
class Backend {
  ...
  async adminCreateLoan(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14) {
    if (this.processError) {
      try {
  ...
  async adminDeleteUser(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async adminGetDeletedLoans(arg0) {
    if (this.processError) {
      try {
  ...
  async adminRestoreLoan(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async adminUpdateLoan(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async adminUpdateUserType(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_PublicUser_n6(_uploadFile, _downloadFile, value) {
  return from_candid_record_n7(_uploadFile, _downloadFile, value);
}
function from_candid_Role_n8(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function from_candid_UserDashboardStats_n32(_uploadFile, _downloadFile, value) {
...
function to_candid_UpdateLoanInput_n28(_uploadFile, _downloadFile, value) {
...
function mapLoan(l) {
  return {
    ...
    requiredAmount: Number(l.required_amount) || void 0,
    sanctionAmount: Number(l.sanction_amount) || void 0,
    disbursedAmount: Number(l.disbursed_amount) || void 0
  };
}
...
async function adminCreateLoan(actor, token, applicantName, bankName, loanType, loanAmount, mobile, distributionPartner = "", coApplicantName = "", employmentType = "", income = 0, propertyType = "", propertyValue = 0, requiredAmount = null, sanctionAmount = null, disbursedAmount = null) {
...
async function adminUpdateLoan(actor, token, loanId, applicantName, bankName, loanType, loanAmount, sanctionAmount, disbursedAmount, requiredAmount) {
  const result = await actor.adminUpdateLoan(token, BigInt(loanId), {
    applicant_name: applicantName,
    bank_name: bankName,
    loan_type: loanType,
    loan_amount: BigInt(loanAmount),
    sanction_amount: sanctionAmount !== void 0 ? BigInt(sanctionAmount) : void 0,
    disbursed_amount: disbursedAmount !== void 0 ? BigInt(disbursedAmount) : void 0,
    required_amount: requiredAmount !== void 0 ? BigInt(requiredAmount) : void 0
  });
  if (result.__kind__ === "err") throw new Error(result.err);
}
...
async function adminUpdateUserType(actor, token, userId, userType) {
...
async function adminDeleteUser(actor, token, userId) {
  const result = await actor.adminDeleteUser(token, BigInt(userId));
  if (result.__kind__ === "err") return { ok: false, err: result.err };
  return { ok: true };
}
async function adminGetDeletedLoans(actor, token) {
  const result = await actor.adminGetDeletedLoans(token);
  if (result.__kind__ === "err") throw new Error(result.err);
  return result.ok.map(mapLoanWithHistory);
}
async function adminRestoreLoan(actor, token, loanId) {
  const result = await actor.adminRestoreLoan(token, BigInt(loanId));
  if (result.__kind__ === "err") throw new Error(result.err);
}
export {
  getLoanDocuments as A,
  adminGetDeletedLoans as B,
  useQuery as a,
  ...
  adminUpdateUserType as p,
  adminDeleteUser as q,
  adminRestoreLoan as r,
  sendOTP as s,
  getMyLoans as t,
  useActor as u,
  verifyOTP as v,
  adminGetAllLoans as w,
  adminGetDashboardStats as x,
  adminGetAllUsers as y,
  adminGetLoanDocuments as z
};
