const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Z0A2bhGv.js","assets/index-KiCAlwBC.css"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
import { f as Subscribable, h as shallowEqualObjects, i as hashKey, k as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, m as noop, p as shouldThrowError, b as getToken, _ as __vitePreload } from "./index-Z0A2bhGv.js";
import { a as useQuery, u as useActor, b as adminCreateLoan, d as adminUpdateLoan, e as adminAddDocument, f as adminDeleteDocument, h as adminRemoveUserFromLoan, i as adminUpdateStage, j as adminUnrejectLoan, k as adminAddUserToLoan, l as adminRejectLoan, m as adminDeleteLoan, n as adminCreateUser, o as adminUpdateAdminMobile, p as adminUpdateUserType, q as adminDeleteUser, r as adminRestoreLoan, c as createActor, t as getMyLoans, g as getLoanById, w as adminGetAllLoans, x as adminGetDashboardStats, y as adminGetAllUsers, z as adminGetLoanDocuments, A as getLoanDocuments, B as adminGetDeletedLoans } from "./api-8PJoCqPW.js";
...
function useAdminCreateLoan() {
  ...
  return useMutation({
    mutationFn: async (params) => {
      ...
      if (!actor || !token) {
        __vitePreload(async () => {
          const { clearSession } = await import("./index-Z0A2bhGv.js").then((n) => n.ap);
          return { clearSession };
        }, true ? __vite__mapDeps([0,1]) : void 0).then(({ clearSession }) => clearSession());
...
function useAdminUpdateUserType() {
  const { actor } = useBackendActor();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (params) => {
...
function useAdminGetDeletedLoans() {
  const { actor, isFetching: actorFetching } = useBackendActor();
  return useQuery({
...
export {
  ...
  useAdminGetDeletedLoans as d,
  useAdminRestoreLoan as e,
  useAdminCreateLoan as f,
  useGetLoanById as g,
  useAdminUpdateLoan as h,
  useAdminGetLoanDocuments as i,
  useAdminAddDocument as j,
  useAdminDeleteDocument as k,
  useAdminRemoveUserFromLoan as l,
  useAdminUpdateStage as m,
  useAdminUnrejectLoan as n,
  useAdminAddUserToLoan as o,
  useAdminRejectLoan as p,
  useAdminCreateUser as q,
  useAdminUpdateUserType as r,
  useAdminDeleteUser as s,
  useAdminUpdateAdminMobile as t,
  useAdminGetDashboardStats as u,
  useGetMyLoans as v,
  useGetLoanDocuments as w
};
