import { o, r as reactExports, v as vt, j as jsxRuntimeExports, a as Settings } from "./index-DmlGt2ze.js";
import { p as useAdminUpdateAdminMobile } from "./useQueries-Cl2674ke.js";
...
function AdminSettingsPage() {
  ...
  const [confirmMobile, setConfirmMobile] = reactExports.useState("");
  ...
  async function handleSubmit(e) {
    ...
    if (newMobile !== confirmMobile) {
      ue.error("Mobile numbers do not match");
      return;
    }
    const result = await updateMobile.mutateAsync(newMobile);
    if (result.ok) {
      ue.success("Admin mobile number updated successfully");
      setNewMobile("");
      setConfirmMobile("");
    } else {
      ue.error(result.err ?? "Failed to update mobile");
    }
  }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 18, style: { color: "#F47B30" } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: "Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Manage admin account settings" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border rounded-xl p-6 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground", children: "Update Admin Mobile Number" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Use this to update your login mobile number. Your current number is hidden for security." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
            {
              ...
              className: "text-sm font-medium text-foreground",
              children: "Confirm Mobile Number"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              inputMode: "numeric",
              value: confirmMobile,
              onChange: (e) => setConfirmMobile(e.target.value.replace(/\D/g, "").slice(0, 10)),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: updateMobile.isPending ? "Updating…" : "Update Mobile Number"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 border rounded-xl p-4 flex gap-3 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "🔐" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Security Note" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Admin mobile number is never displayed in the UI or returned in any API response. After updating, use your new mobile number to log in." })
      ] })
    ] })
  ] });
}
