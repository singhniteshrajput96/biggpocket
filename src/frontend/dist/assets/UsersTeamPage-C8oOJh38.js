...
import { a as useAdminGetAllUsers, b as useAdminGetAllLoans } from "./useQueries-Cl2674ke.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground", children: "Users & Teams" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium text-left", children: "Actions" })
            ]
          }
        ) }),
          ...
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  className: "text-xs font-semibold px-2 py-0.5 rounded-full",
                  style: stat.rejected > 0 ? { backgroundColor: "#fef2f2", color: "#dc2626" } : { backgroundColor: "#f4f4f5", color: "#71717a" },
